      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-auto">
        ...
        <BentoCard spotlight className="md:col-span-4 md:row-span-1 flex flex-col justify-between border-blue-500/20 dark:border-blue-500/20">
          <div>
            <div className="flex flex-col md:flex-row md:justify-between items-start mb-10">
              ...
              <div className="flex gap-2">
                ...
                */}
                  ...
                  <a href="https://github.com/wegii" target="_blank" className="p-3 bg-white/5 rounded-2xl hover:bg-white hover:text-black dark:hover:text-black transition-all cursor-pointer">
                   <Github size={20}/>
                 </a>
                 <a href="https://linkedin.com/in/wegii" target="_blank" className="p-3 bg-white/5 rounded-2xl hover:bg-white hover:text-black dark:hover:text-black transition-all cursor-pointer">
                   <Linkedin size={20}/>
                 </a>
                 <a href="https://scholar.google.com/citations?hl=en&user=aPmT8iQAAAAJ" target="_blank" className="p-3 bg-white/5 rounded-2xl hover:bg-white hover:text-black dark:hover:text-black transition-all cursor-pointer" title="Google Scholar">
                   <GraduationCap size={20}/>
                 </a>
                 <a href="mailto:wegmannp@in.tum.de" className="p-3 bg-white/5 rounded-2xl hover:bg-white hover:text-black dark:hover:text-black transition-all cursor-pointer">
                   <Mail size={20}/>
                 </a>
            ...
            <p className="text-zinc-400 text-lg leading-relaxed" dangerouslySetInnerHTML={{ __html: d.profile.bio }}>
            </p>
          </div>
        ...
        <BentoCard className="md:col-span-2 md:row-span-1">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-xl font-bold text-white">Thesis</h2>
          </div>
          <div className="space-y-4">
            {d.theses.map((t, i) => (
          ...
          <div className="space-y-4">
            {d.education.map((edu, i) => (
              <div key={i} className="relative pl-6 border-l border-white/10 group/edu">
                ...
                <div className="flex items-center gap-2 text-[10px] text-zinc-500 font-mono uppercase tracking-tighter">
                  <Milestone size={12} /> {edu.specialization}
                </div>                
              </div>
            ))}
          </div>
